...
public class BitmapUtil {
     ...
     *
     * @param bmp     原始位图
     * @param centerX 阳光中心位置的X坐标
     * @param centerY 阳光中心位置的Y坐标
     * @return 处理后的位图
     */
     ...
     */
    public static boolean saveBitmap(Bitmap bmp, String path, String name, int quality) {
