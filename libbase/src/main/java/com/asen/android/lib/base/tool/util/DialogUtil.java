...
public class DialogUtil {
     ...
     * 简单的消息弹出框
     *
     * @param activity  显示的页面activity
     * @param title     标题
     * @param message   内容
     * @param btnTexts  最多三条有效值
     * @param listeners 按钮监听
     */
    ...
    public static void showTitleMessageDialog(Activity activity, CharSequence title, CharSequence message, DialogInterface.OnClickListener listener) {
        showTitleMessageDialog(activity, title, message, new CharSequence[]{"确认", "取消"}, new DialogInterface.OnClickListener[]{listener});
    }
     ...
     *
     * @param activity 显示的页面activity
     * @param itemsId  stringArray的资源文件id
     * @param tvShow   要显示的TextView
     * @param listener 监听事件
     */
