...
//    private TableConfig mTableConfig; // 表信息
     ...
     * @param values         要插入的参数
     */
    public ReplaceBuilder(String table, String nullColumnHack, ContentValues values) {
     ...
     */
    public ReplaceBuilder(String sql, Object[] params) {
        super(sql, params);
    }
     ...
     */
    public ReplaceBuilder(Object senObj) {
        super(senObj);
    }
...
//     * @param json JSON串形式
//     */
//    public ReplaceBuilder(String json) {
//        super(json);
//    }
...
//                boolean autoincrement = annotation.autoincrement();
    ...
    /**
     * 将jsonObject转换成 ReplaceBuilder对象
     *
     * @param jsonObject JSON对象
     * @return ReplaceBuilder对象
     */
    public static ReplaceBuilder fromJson(JSONObject jsonObject) throws SQLException, ClassNotFoundException, IllegalAccessException, InstantiationException, InvocationTargetException {
        ...
        if (builderType == BuilderType.SQL) {
            ...
            return new ReplaceBuilder(sql, JsonUtil.jsonArrayToList(paramsArray).toArray());
        } else if (builderType == BuilderType.ANDROID_SQL) {
            // Android的SQL执行
            ...
            return new ReplaceBuilder(tableName, nullColumnHack, contentValues);
        } else if (builderType == BuilderType.OBJECT) {
            // 获取参数对象
